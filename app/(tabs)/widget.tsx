...
const styles = StyleSheet.create({
  ...
  widgetSmallDay: { fontSize: 48, fontWeight: '700', color: '#fff', lineHeight: 52 },
  widgetSmallLunar: { fontSize: 14, color: 'rgba(255,255,255,0.85)', fontWeight: '500' },
  widgetSmallGanzhi: { fontSize: 11, color: 'rgba(255,255,255,0.65)', marginTop: 2 },
  widgetMedium: {
    width: 270,
    height: 130,
    backgroundColor: Colors.primary,
  ...
  widgetMedDay: { fontSize: 48, fontWeight: '700', color: '#fff', lineHeight: 52 },
  widgetMedMonth: { fontSize: 13, color: 'rgba(255,255,255,0.75)', fontWeight: '600' },
  widgetMediumRight: { flex: 1, gap: 2 },
  widgetMedLunarDay: { fontSize: 16, color: '#fff', fontWeight: '600' },
  widgetMedGanzhi: { fontSize: 12, color: 'rgba(255,255,255,0.8)' },
  widgetMedZodiac: { fontSize: 12, color: 'rgba(255,255,255,0.65)' },
  widgetMedFestival: {
    fontSize: 11,
    color: '#FFD580',
    fontWeight: '600',
